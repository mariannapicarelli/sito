<?php add_action('admin_menu','hotel_melbourne_add_opiotn_page_marianna');
function hotel_melbourne_add_opiotn_page_marianna(){
$page = add_theme_page( __('Hotel Melbourne','hotel-melbourne'), __('About Theme','hotel-melbourne'), 'edit_theme_options', 'hotel-melbourne', 'hotel_melbourne_option_panal_function_marianna' );
add_action('admin_print_styles-'.$page, 'hotel_melbourne_admin_enqueue_scripts_marianna');
} 

 function hotel_melbourne_admin_enqueue_scripts_marianna()
{
...
function hotel_melbourne_option_panal_function_marianna()
